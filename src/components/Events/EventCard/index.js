    ...
    render(){
        return (
            <div className='event-card'>
                ...
                <p className='event-card__details'><span className='event-card__icons'><i className="fas fa-calendar-day"></i></span> 25th August 2020</p>
                <p className='event-card__details'><span className='event-card__icons'><i className="fas fa-clock"></i></span> 2:30 - 3:30 PM</p>
                <p className='event-card__details'><span className='event-card__icons'><i className="fas fa-map-marker-alt"></i></span> MS Teams</p>
